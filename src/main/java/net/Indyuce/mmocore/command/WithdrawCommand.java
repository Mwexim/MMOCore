...
public class WithdrawCommand extends BukkitCommand {
	...
	public boolean execute(CommandSender sender, String label, String[] args) {
		...
		try {
			...
			sender.sendMessage(MMOCore.plugin.configuration.getSimpleMessage("wrong-number", "arg", "" + args[0]).message());
			return true;
		}
		...
		MMOCore.plugin.configuration.getSimpleMessage("withdrew", "worth", "" + amount).send(player);
		return true;
	}
}
